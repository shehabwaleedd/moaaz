    ...
    return (
        <>
                ...
                <div className="contact__container container">
                    <div className="contact__left">
                        <div className="left__upper">
                            ...
                            <span><a href="mailto: info@moaazaskaar.com">info@moaazaskaar.com</a></span>
                        </div>
                    </div>
            ...
            <div className="contact__footer">
                <div className="contact__footer_container">
                    <h1>MOAAZ ASKAAR</h1>
                    <h4>
                        Desgined and Coded by <a href="https://shehabwaleedd.vercel.app/">Shehab Waleed</a>
                    </h4>
                </div>
            </div>
            </motion.section>
