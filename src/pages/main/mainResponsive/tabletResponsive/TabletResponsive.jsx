...
const TabletResponsive = ({ isPlaying, setIsPlaying, audioRef, toggleMusic, beat, main }) => {
    return (
        <main className='main'>
            ...
            <div className="main__container-tablet">
                <motion.div className="main__title-tablet">
                ...
                <div className="main__text-container-tablet">
                ...
                <div className="main__image-tablet">
                    <img src={main} alt="main_image-tablet" />
                    <motion.div initial={{ opacity: 0, transition: { delay: 0.3, staggerChildren: 3.5, duration: 1, ease: [0.42, 0, 0.58, 1] } }} animate={{ opacity: 1, transition: { delay: 0.5, staggerChildren: 3.5, duration: 1, ease: [0.42, 0, 0.58, 1] } }} exit={{ opacity: 0, transition: { velocity: 2, staggerChildren: 1.5, duration: 0.5, ease: [0.42, 0, 0.58, 1] } }}
                        className="image__circle-tablet"
                        onClick={toggleMusic}>
                        <div className={`circle__inner ${isPlaying ? 'waves' : ''}`}>
                            <BiSolidMusic style={{ fontSize: "2rem" }} />
                        </div>
                    </motion.div>
                </div>
